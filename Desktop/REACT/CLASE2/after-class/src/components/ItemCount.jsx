...
const ItemCount = ({stock, onAdd}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <div className="col-md-6 text-center">
                    {vendido ? <Link to={"/cart"} className="btn btn-outline-info">Terminar Mi Compra</Link> : <button type="button" className="btn btn-outline-info" onClick={() => { addToCart(counter) }}>Agregar al Carrito</button>}
                </div>
            </div>
        </div>
    )
